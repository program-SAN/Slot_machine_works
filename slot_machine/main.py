    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 0 < lines <= MAX_LINES:
                ...
                print("enter valid numbe rof lines")
...
def spin(balance):
    ...
    while True:
        ...
        total = bet * lines
        if total > balance:
            print(f"you do not have that much amount, your current balance is :${balance}")
        else:
            break
...
def main():
    ...
    while True:
        ...
        answer = input("Press enter to continue and (q) to quit the game :")
        if answer == "q":
            break
